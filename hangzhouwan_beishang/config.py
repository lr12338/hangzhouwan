from utils_demo.find_ship import beixia_predict_longitude_latitude,beishang_predict_longitude_latitude
...
font_path='D:\huangchao\hangzhouwan_beishang\weights\simhei.ttf'

# find_ship需改model_path
# beixia_predict_longitude_latitude(x1, y1, x2, y2, model_path=r'D:\huangchao\hangzhouwan_beishang\weights\0121_random_forest_model.pkl')
#...